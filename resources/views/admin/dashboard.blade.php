...
<div class="row gy-4">
    <div class="col-xl-6">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">@lang('Subscriptions Report (last 30 days)')</h5>
    ...
    <div class="col-xl-6">
        <div class="row gy-4">
                ...
                <a href="{{route('admin.plan.index')}}">
                    <div class="card prod-p-card background-pattern-white bg--primary">
                        <div class="card-body">
                            <div class="row align-items-center m-b-0">
                                <div class="col">
                                    <h6 class="m-b-5 text-white">@lang('Total Plan')</h6>
                                    <h3 class="m-b-0 text-white">{{__($totalPlan)}}</h3>
                                </div>
                                <div class="col-auto">
                                    <i class="dashboard-widget__icon las la-gift text-white"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{route('admin.service.index')}}">
                    <div class="card prod-p-card background-pattern">
                        <div class="card-body">
                            <div class="row align-items-center m-b-0">
                                <div class="col">
                                    <h6 class="m-b-5">@lang('Total Services')</h6>
                                    <h3 class="m-b-0">{{__($totalService)}}</h3>
                                </div>
                                <div class="col-auto">
                                    <i class="dashboard-widget__icon lab la-servicestack"></i>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-4">
                <a href="{{route('admin.service.approved.orders')}}">
                    <div class="card prod-p-card background-pattern">
                        <div class="card-body">
                            <div class="row align-items-center m-b-0">
                                <div class="col">
                                    <h6 class="m-b-5">@lang('Total Orders')</h6>
                                    <h3 class="m-b-0">{{__($orders['total_order'])}}</h3>
                                </div>
                                <div class="col-auto">
                                    <i class="dashboard-widget__icon las la-cart-arrow-down"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{route('admin.service.approved.orders')}}">
                    <div class="card prod-p-card background-pattern">
                        <div class="card-body">
                            <div class="row align-items-center m-b-0">
                                <div class="col">
                                    <h6 class="m-b-5">@lang('Total Orders Approved')</h6>
                                    <h3 class="m-b-0">{{__($orders['total_approved'])}}</h3>
                                </div>
                                <div class="col-auto">
                                    <i class="dashboard-widget__icon las la-cart-arrow-down"></i>
                                </div>
            ...
            <div class="col-sm-4">
                <a href="{{route('admin.service.pending.orders')}}">
                    <div class="card prod-p-card background-pattern">
                        <div class="card-body">
                            <div class="row align-items-center m-b-0">
                                <div class="col">
                                    <h6 class="m-b-5">@lang('Total Orders Pending')</h6>
                                    <h3 class="m-b-0">{{__($orders['total_pending'])}}</h3>
                                </div>
                                <div class="col-auto">
                                    <i class="dashboard-widget__icon las la-cart-arrow-down"></i>
                                </div>
