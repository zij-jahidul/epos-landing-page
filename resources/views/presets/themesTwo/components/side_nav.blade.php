...
$user = auth()->user();
@endphp
<div class="col-xl-3 col-lg-12 pe-xl-4">
            ...
            <li class="sidebar-menu-list__item has-dropdown">
                ...
                <div class="sidebar-submenu">
                    <ul class="sidebar-submenu-list">
                        <li class="sidebar-submenu-list__item {{ Route::is('user.orders') ? 'active' : '' }}">
                            <a href="{{route('user.orders')}}" class="sidebar-submenu-list__link">@lang('All Orders')</a>
                        </li>
                        <li class="sidebar-submenu-list__item {{ Route::is('user.approved.orders') ? 'active' : '' }}">
                            <a href="{{route('user.approved.orders')}}" class="sidebar-submenu-list__link">@lang('Approved Orders')</a>
                        </li>
                        <li class="sidebar-submenu-list__item {{ Route::is('user.pending.orders') ? 'active' : '' }}">
                            <a href="{{route('user.pending.orders')}}" class="sidebar-submenu-list__link">@lang('Pending Orders')</a>
                        </li>
                    </ul>
                </div>
            </li>

            <li class="sidebar-menu-list__item {{ Route::is('user.fetch.subscription') ? 'active' : '' }}">
                <a href="{{ route('user.fetch.subscription') }}" class="sidebar-menu-list__link">
