                ...
                <form action="{{ route('user.deposit.manual.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <p class="text-center mt-2">@lang('You have requested') <b class="text-success">{{
                                    showAmount($data['amount']) }} {{__($general->cur_text)}}</b> , @lang('Please pay')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <button type="submit" class="btn--base mt-3">@lang('Pay Now')</button>
                            </div>
                        </div>
                    </div>
                </form>
